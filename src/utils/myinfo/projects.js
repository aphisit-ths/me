export const projects = [
  ...
  {
    projectName: 'STROKE PREDICTION ',
    desc: 'Simple Machine learning application  ',
    stack: ['Stramlit', 'Python', 'Python for Machine Learning'],
    githubLink: 'https://github.com/aphisit-ths/MACHINE-LEARNING-ASSIGNMENT',
    type: 'Web Development',
    imgUrl: '/streamlit.gif',
  },
  {
    projectName: 'Worldly',
    desc: 'frontend',
    stack: ['React', 'FastAPI'],
    githubLink: 'https://github.com/aphisit-ths/MACHINE-LEARNING-ASSIGNMENT',
    type: 'Web Development & Web Scraping',
    imgUrl: '/worldly.gif',
  },
];
